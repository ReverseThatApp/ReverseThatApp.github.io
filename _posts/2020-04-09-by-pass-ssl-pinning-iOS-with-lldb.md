...
image:
    path: /images/br/lldb-attached.png
    alt: LLDB Attached
tags: [ios, lldb, ssl-pinning, iap, burp-suite, bypass]
---
...
![LLDB Attached]({{ site.baseurl }}/images/br/lldb-attached.png)
_**Figure: LLDB Attached**_
...
By starting search **https endpoints** strings in that order using `strings` command - *strings  looks  for  ASCII  strings in a binary file or standard input.  strings is useful for identifying random object files and many other things*, we can find some outcomes in the REDACTED Mach-O file.
```bash
...
![registers]({{ site.baseurl }}/images/br/registers.png)
_**Figure: Registers**_
![registers purpose]({{ site.baseurl }}/images/br/registers-purpose.png)
_**Figure 8: Registers purpose**_
...
![Change register x2 to new value]({{ site.baseurl }}/images/br/hopper-sniff-http-requests.png)
_**Figure: Hopper Disassembler can see applications requests & responses**_
