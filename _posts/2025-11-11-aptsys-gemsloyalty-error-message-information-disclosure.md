---
layout: post
title: "[CVE-2025-52022] Information disclosure via verbose error messages in Aptsys gemsloyalty backend"
categories: [Disclosure]
tags: [cve, information-disclosure, stack-trace, error-handling, security]
permalink: /disclosures/aptsys-gemsloyalty-error-message-information-disclosure
date: 2025-11-11
---

## Summary

An **information disclosure** vulnerability was identified in the backend of Aptsys’ **gemsloyalty** platform, which powers POS and management systems for multiple F&B clients.  
...
> CVE: **CVE-2025-52022** (*Reserved - pending public publication*)  
...
Subsequent review confirmed that unauthenticated users could directly trigger similar error messages by sending malformed requests to certain public API endpoints hosted on gemsloyalty backend.
...
- **Product:** gemsloyalty backend server  
...
A backend API endpoint in the gemsloyalty platform fails to properly handle invalid input or unexpected parameters.  
...
An attacker can send crafted GET or POST requests to public API endpoints (e.g., group or service-related routes) on the gemsloyalty backend.  
...
Operators of Aptsys gemsloyalty deployments should treat this as a high-severity issue and apply mitigations immediately. Vendors and CERT teams may contact the reporter for full technical details.
